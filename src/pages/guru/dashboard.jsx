...
import { Users, BookOpen, Edit, MonitorPlay, BarChart3, PieChart } from 'lucide-react'; // Sesuaikan ikon yang dipakai
    ...
    >
      <div>
        <div className="flex justify-between items-start mb-3">
          ...
          <div className="p-2.5 rounded-full bg-white bg-opacity-25"> {/* Background ikon dibuat transparan */}
...
const DashboardSection = ({ title, icon, children, animationDelay, className }) => {
    const IconComponent = icon;
    return (
        <div 
        ...
        >
            <div className="flex items-center mb-4">
                {IconComponent && <IconComponent size={20} className="text-orange-500 mr-2.5" />}
      ...
      <main className="flex-1 md:ml-64 md:pt-16 p-4 md:p-6 lg:p-8 bg-gradient-to-br from-slate-50 to-gray-100 min-h-screen mt-15">
        ...
        <div className="max-w-full mx-auto bg-white rounded-xl shadow-xl p-6 md:p-8">
          <div className="mb-8 animate-fade-in-up" style={{animationDelay: '0.1s'}}>
            <h1 className="text-2xl md:text-3xl font-bold text-gray-800">Dashboard Guru</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            <DashboardSection title="Aktivitas Kelas (Contoh)" icon={BarChart3} animationDelay="0.6s" className="lg:col-span-1">
              <ul className="space-y-2 text-sm">
                  <li className="text-gray-600 border-b border-slate-200 pb-1.5">Murid A mengumpulkan tugas "Aljabar Bab 1".</li>
                  <li className="text-gray-600 border-b border-slate-200 pb-1.5">Sesi Live "Kalkulus Lanjutan" akan dimulai besok.</li>
                  <li className="text-gray-600">Anda memberikan nilai untuk tugas "Descriptive Text".</li>
              </ul>
            </DashboardSection>
            <DashboardSection title="Distribusi Nilai (Contoh)" icon={PieChart} animationDelay="0.7s" className="lg:col-span-2">
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/guru/sesi-live">
                <button className={`flex items-center space-x-2 ${primaryButtonColor} ${primaryButtonTextColor} px-4 py-2 rounded-lg shadow-md text-sm font-medium`}>
                  <MonitorPlay size={18}/> <span>Jadwalkan Sesi Live</span>
                </button>
              </Link>
              <Link href="/guru/tugas">
                <button className={`flex items-center space-x-2 bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg shadow-md text-sm font-medium`}>
