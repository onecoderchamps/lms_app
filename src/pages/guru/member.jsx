            ...
            <div className="overflow-x-auto border border-gray-200 rounded-lg">
                <table className="min-w-full bg-white">
                    <thead className="bg-gray-50 border-b-2 border-gray-200">
                        <tr>
                            <th className="px-6 py-4 text-left text-sm font-semibold text-gray-600 uppercase tracking-wider">No.</th>
                    ...
                    <tbody className="divide-y divide-gray-200">
                        {murids.length === 0 ? (
                            <tr><td colSpan="4" className="text-center py-10 text-gray-500">Belum ada murid di kelas ini.</td></tr>
                        ) : (
    ...
    return (
        <MainLayout>
            <main className="flex-1 md:ml-64 md:pt-16 p-4 md:p-6 lg:p-8 bg-white min-h-screen mt-15">
                ...
                {/* --- Modals (dipindahkan ke dalam MainLayout) --- */}
